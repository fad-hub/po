    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl position-relative p-0" id="home">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse d-flex flex-row-reverse" id="navbarCollapse">
                    <div class="navbar-nav mx-0 py-0">
                ...
                <div class="container px-lg-5">
                    <div class="row g-5">
                        <div class="col-lg-8 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">Urusan Laundry Lebih Mudah Dengan LaunDream</h1>
                            ...
                            <a href="" class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill me-3 animated slideInLeft">Download Now</a>
                        </div>
                        <div class="col-lg-4 d-flex justify-content-center justify-content-lg-end wow fadeInUp" data-wow-delay="0.3s">
                            <div class="owl-carousel screenshot-carousel">
                                <img class="img-fluid" src="image/screenshot-1.png" alt="">
                                <img class="img-fluid" src="image/screenshot-2.png" alt="">
                                <img class="img-fluid" src="image/screenshot-3.png" alt="">
                                <img class="img-fluid" src="image/screenshot-4.png" alt="">
                                <img class="img-fluid" src="image/screenshot-5.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xxl py-5" id="about">
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.5s" src="image/about.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xxl py-5" id="feature">
            <div class="container py-5 px-lg-5">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h1 class="mb-5">Fitur LaunDream</h1>
                </div>
                <div class="row g-4">
        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <img class="img-fluid wow fadeInUp" data-wow-delay="0.1s" src="image/about.png">
                    </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5">
                    <div class="col-md-6 col-lg-3">
                        ...
                        <p><i class="fa fa-map-marker-alt me-3"></i>Bandar Lampung, Lampung, Indonesia</p>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">Laundream</a>, All Right Reserved. 
